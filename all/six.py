...
# Configure logging
logging.basicConfig(filename='chatbot6.log', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')

app = Flask(__name__)

WELCOME_MENU = (
    "Hello 👋\n"
    "Welcome to Evolve Rotterdam.\n"
    "1️⃣ About us\n"
    "2️⃣ Prices\n"
    "3️⃣ Online booking 📅\n"
