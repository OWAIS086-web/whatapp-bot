...
COMMON_RESPONSES = {
    'hello': [
        "Hello! How can I assist you today? 😊 'menu' to see the options.",
        "Hi there! How can I help you? 🤔 'menu' to see the options.",
        "Hey! What can I do for you? 🙌 'menu' to see the options.",
        "Greetings! How may I be of service? 👋 'menu' to see the options.",
        "Hello! What can I do for you today? 😃 'menu' to see the options."
    ],
    'bye': [
        "Goodbye! Have a great day! 👋 'menu' to see the options.",
        "See you later! 👋 'menu' to see the options.",
        "Bye! Take care! ✨ 'menu' to see the options.",
        "Farewell! Wishing you the best! 🌟 'menu' to see the options.",
        "Catch you later! 😊 'menu' to see the options."
    ],
    'thanks': [
        "You're welcome! 😃 'menu' to see the options.",
        "Happy to help! 😊 'menu' to see the options.",
        "No problem at all! 👍 'menu' to see the options.",
        "You're welcome! If you need anything else, just ask! 🙏 'menu' to see the options.",
        "Glad I could assist! 😄 if you want 'menu' to see the options. "
    ]
}
...
def sms_reply():
        ...
        if option_id == '4':
            ...
            if details and details.get('success'):
                if option_id == '1':  # About Us
                    ...
                    booking_response = f"{COMPANY_NAME} - Online booking 📅:\n{details.get('booking_link', 'Booking details unavailable.')}\n\nPress 0️⃣ to go back."
    ...
    # Handle appointment cancellation (Pending option 4)
        ...
        # Invalid selection
        msg.body("Invalid selection. Please try again or type 'menu' to see the options.")
